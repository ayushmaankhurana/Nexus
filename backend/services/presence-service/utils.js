// utils.js - Utility functions for Presence & Location Service
 ...
 * @param {{lat: number, lng: number, radius: number}} zone - Zone definition
 * @returns {boolean} true if inside, false otherwise
 */
function isInsideGeofence(userLocation, zone) {
 ...
 * @param {any} location - Location object to validate
